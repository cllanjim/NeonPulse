...
//	}
	...
	Object message
	    This required argument specifies what the dialog should render in its main area. Generally, you
	...
	You can either let the option pane render its default icon or specify the icon using the message
	...
	render a standard icon or no icon, specify the message type corresponding to the icon you desire.
