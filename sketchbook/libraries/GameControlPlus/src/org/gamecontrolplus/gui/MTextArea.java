 ...
 *
 */
public class MTextArea extends MEditableTextControl {
	 ...
	 * @param p3
	 */
	public MTextArea(PApplet theApplet, float p0, float p1, float p2, float p3) {
	 ...
	 * @param sbPolicy
	 */
	public MTextArea(PApplet theApplet, float p0, float p1, float p2, float p3, int sbPolicy) {
...
//		th = height - 2 * TPAD6 - ((scrollbarPolicy & SCROLLBAR_HORIZONTAL) != 0 ? 18 : 0);
		...
		// The text wrap width is based on the width of the text render area unless
...
//		M4P.addControl(this);
	...
	/**
	 * Set the text to render and adjust any scrollbars
...
//		this.wrapWidth = wrapWidth;
	...
	/**
	 * Set the text to render and adjust any scrollbars
	 * @param text lines of text to render
	 */
	...
	protected void updateBuffer(){
		if(bufferInvalid) {
			...
			// Now move to top left corner of text render area
			...
			// Translate in preparation for render selection and text
			if(hasSelection()){
	...
	public void draw(){
		...
		// Draw caret if text render area
