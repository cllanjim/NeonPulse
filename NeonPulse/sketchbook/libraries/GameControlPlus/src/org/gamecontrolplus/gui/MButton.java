 ...
 *
 */
public class MButton extends MTextIconAlignBase {
	...
	public MButton(PApplet theApplet, float p0, float p1, float p2, float p3) {
	...
	public void mouseEvent(MouseEvent event){
		...
		case MouseEvent.RELEASE:	
			...
			if(focusIsWith == this && dragging){
				if(reportAllButtonEvents)
					fireEvent(this, MEvent.RELEASED);
				dragging = false;
				loseFocus(null);
				status = OFF_CONTROL;
				bufferInvalid = true;
