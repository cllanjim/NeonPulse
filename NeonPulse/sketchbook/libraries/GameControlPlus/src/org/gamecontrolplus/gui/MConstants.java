...
public interface MConstants {
	...
	/** Do not create or render any scrollbars for the text control. */
	int SCROLLBARS_NONE 			= 0x0000;
	/** Create and render vertical scrollbar only. */
	int SCROLLBARS_VERTICAL_ONLY 	= 0x0001;
	/** Create and render horizontal scrollbar only. */
	int SCROLLBARS_HORIZONTAL_ONLY 	= 0x0002;
	/** Create and render both vertical and horizontal scrollbars. */
